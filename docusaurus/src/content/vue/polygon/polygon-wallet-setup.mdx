...
You're  now ready to build out the Polygon wallet!
The following code snippets will allow you to use the Polygon Wallet in any component in your application. 
...
<ContentBlock filePath={'src/Wallet.tsx'} highlight={'46-70'}>
...
<ContentBlock filePath={'src/Wallet.tsx'} highlight={'72-76'}>
